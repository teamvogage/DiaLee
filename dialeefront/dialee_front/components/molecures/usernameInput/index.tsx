...
const VoyagerNameInput=({value,onChangeHandler,goToPwd,goToConfirm}:ComponentProps<any>)=>{
    const voyagerNameRef=useRef<HTMLInputElement>(null);
    ...
    const debouncedChange=useCallback(debounce((name:string,value:string)=>onChangeCallback(name,value),100),[]);
...
export default VoyagerNameInput